...
if [[ $# -ne 1 ]];
then
	echo "Usage: ./setup_big_fin <Container Name>"
 	echo "ERROR: incorrect params in $(pwd)/setup_big_fin.sh (2)" >> scripts.log
	exit 2
fi
...
echo "SUCCESS: $(pwd)/setup_big_fin.sh (0)" >> scripts.log
exit 0
