...
cont_type=`cat ~/.recycle_util_$cont_name | cut -d' ' -f3`
...
sudo mv /home/student/MITM/logs/logins/$1.log ~/attacker_logs/$date/logins
sudo mv /home/student/MITM/logs/logouts/$1.log ~/attacker_logs/$date/logins
